...
namespace UtilsCuda
{
	/// Bindless CUDA 1D Texture of Type
	template <typename Type>
	class BindlessTexture1D
	{
	public:
		...
		BindlessTexture1D(int w, const Type * buffer, bool buffer_is_device=false, bool interpolate=true, bool normalizedCoords=false);
